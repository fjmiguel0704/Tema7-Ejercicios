...
/**
 * Esta clase almacena la información de un artículo de tienda. Calculando para
 * el su precio con IVA aplicado y descuento del producto. Si se vende un
 * artículo o si se almacena , se atualizará la cantidad de artículos en stock
 * 
 * @author fjmiguel
 *
 */
